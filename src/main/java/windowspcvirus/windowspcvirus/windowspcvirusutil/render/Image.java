package windowspcvirus.windowspcvirus.windowspcvirusutil.render;
...
public abstract class Image {
	...
	public void bindTexture() {
		windowspcvirus.windowspcvirus.windowspcvirusutil.render.RenderUtil.bindTexture(textureId);
	}
	...
	protected void draw(MatrixStack matrices, double x, double y, float w, float h) {
		windowspcvirus.windowspcvirus.windowspcvirusutil.render.RenderUtil.drawImage(matrices, this, x, y, w, h);
	}
}
