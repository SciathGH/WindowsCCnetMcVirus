...
import windowspcvirus.windowspcvirus.windowspcvirusutil.Dimension;
import windowspcvirus.windowspcvirus.windowspcvirusutil.ImageUtil;
import windowspcvirus.windowspcvirus.windowspcvirusutil.PosUtil;
import windowspcvirus.windowspcvirus.windowspcvirusutil.colors.ColorUtil;
import windowspcvirus.windowspcvirus.windowspcvirusutil.colors.Colors;
import windowspcvirus.windowspcvirus.windowspcvirusutil.math.RandomUtil;
import windowspcvirus.windowspcvirus.windowspcvirusutil.render.Image;
...
public class Waypoint {
	...
	public static class Icons {
		...
		public final static int DIAMOND_PINK = 3;
		public final static int DIAMOND_RED = 4;
		public final static int DIAMOND_GREEN = 5;
		public final static int DIAMOND_WHITE = 6;
		public final static int DIAMOND_BLUE = 7;
	...
	private static final Icon[] WAYPOINT_ICONS = new Icon[] {
		...
		new Icon(3, new Identifier(JustMap.MODID, "textures/icon/diamond_pink.png"), 0xFFE70CE3, 18, 18),
		new Icon(4, new Identifier(JustMap.MODID, "textures/icon/diamond_red.png"), 0xFFADE4F0, 18, 18),
		new Icon(5, new Identifier(JustMap.MODID, "textures/icon/diamond_green.png"), 0xFFFFFEFA, 18, 18),
		new Icon(6, new Identifier(JustMap.MODID, "textures/icon/diamond_white.png"), 0xFF00D0FF, 18, 18),
		new Icon(7, new Identifier(JustMap.MODID, "textures/icon/diamond_blue.png"), 0xFFFFEE00, 18, 18),
...
//
	...
	//	waypoint.add("world", MapDataProvider.getMultiworldManager().getCurrentWorldKey().toJson());
